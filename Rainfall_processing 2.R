# This script describes the preparation of rainfall data
#
...
setwd("~/Arbeit/Lehre_Betreuung/2017/SS/Summer_academy/Modelling/Rainfall")

# we prepare rainfall data
...
rasfiles <- list.files(path = "http://github.com/rbslandau/Sum_acad_spatmod/Rainfall/ARC2/",full.names=TRUE)  
